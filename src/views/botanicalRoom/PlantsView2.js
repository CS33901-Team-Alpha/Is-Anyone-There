class PlantsView2 extends View {
    constructor() {
        ...
        this.plants = [new PlantObject(12, 6, 'placeholderPlant6', new InspectComponent(
            'Sorbitol',
            ...
            new PlantObject(4, 6, 'placeholderPlant5', new InspectComponent(
            ...
            new PlantObject(7, 5.8, 'placeholderPlant7', new InspectComponent(
            'Ammonia',
